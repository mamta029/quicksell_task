...
import List from './Components/KanbanBoard/KanbanBoard';
        ...
        'status': <>
          {
            statusList.map((listItem) => {
              return (
                <List
                  key={listItem} // Add a unique key for each List
                  groupValue={groupValue} // Pass groupValue here
                  orderValue={orderValue}
                  listTitle={listItem}
                  listIcon=''
        ...
        'priority': <>
          {
            priorityList.map((listItem) => {
              return (
                <List
                  key={listItem.priority} // Add a unique key for each List
                  groupValue={groupValue} // Pass groupValue here
                  orderValue={orderValue}
